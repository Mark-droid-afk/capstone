...
const OrderModal = ({ showDetails, showEdit, toggleModal, order }: any) => {
  ...
  return (
    <>
      ...
      >
        <div className="shadow-7 relative w-full max-w-[700px] min-h-[300px] h-auto py-8 scale-100 transform rounded-[15px] bg-white transition-all flex flex-col justify-start items-center">
          <button
