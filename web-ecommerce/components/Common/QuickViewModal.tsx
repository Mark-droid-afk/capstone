  ...
  const handleAddToCart = () => {
    const itemToAdd = selectedVariation
      ? {
          ...
          discountedPrice: selectedVariation.discountedPrice,
          title: `${product.title} (${selectedVariation.weight})`,
          quantity,
        }
      : {
          ...product,
        ...
        <div className="w-full max-w-[1100px] rounded-xl shadow-3 bg-white p-7.5 relative modal-content">
          ...
          <div className="flex flex-wrap items-center gap-12.5">
            ...
            <div className="max-w-[445px] w-full">
              ...
              <p>
                A delicious treat from Bren Raphael. Enjoy the rich and authentic taste of our products.
              </p>
                ...
                <div>
                  ...
                  <span className="flex items-center gap-2">
                    <span className="font-semibold text-dark text-xl xl:text-heading-4">
                      ₱{selectedVariation ? selectedVariation.discountedPrice : product.discountedPrice}
                    </span>
