...
const Header = () => {
  ...
  const options = [
    ...
    { label: "Ube Halaya", value: "1" },
    { label: "Ube Jam", value: "2" },
  ];
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link className="flex-shrink-0" href="/">
              ...
              >
                ...
                />
                <path
                  d="M8 10 L8 46 M8 10 L26 10 Q36 10 36 20 Q36 29 26 29 L8 29 M8 29 L28 29 Q38 29 38 38 Q38 46 28 46 L8 46"
                  fill="none"
                  stroke="white"
                  strokeWidth="3.2"
                  strokeLinecap="round"
                ...
                {/* <!-- Subtitle — remove or change this --> */}
                <text
                  x="56"
                  y="54"
                  fontFamily="Georgia, serif"
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-6 xl:gap-8">
                <span className="hidden sm:block w-px h-7.5 bg-gray-4"></span>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    >
                      <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className="group-hover:fill-blue duration-200"
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                      ...
                      <div>
                        ...
                        <p className="font-medium text-custom-sm text-dark group-hover:text-blue duration-200">
                          My Account
                        </p>
                      </div>
                    </Link>
                    <button
                      ...
                      className="text-custom-sm text-red-500 font-medium hover:underline"
                    >
                      Logout
                    </button>
                  </div>
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="group-hover:stroke-blue duration-200"
                  >
