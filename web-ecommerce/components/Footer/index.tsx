          ...
          <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
            <div className="max-w-[330px] w-full">
              ...
              <div className="flex items-center gap-4 mt-7.5">
                <a
                  href="https://www.facebook.com/p/Bren-Raphaels-Ube-Jam-Halaya-61569613527256/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/brenraphaelsubejamhalaya"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* TikTok Link Updated Below */}
                <a
                  href="https://www.tiktok.com/@bren.raphaels.ube"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  ...
                  >
                    <path
                      d="M12.525 2c.381 0 .736.218.913.555.337.643.82 1.192 1.417 1.61A6.685 6.685 0 0 0 18.75 5.25v2.5a9.13 9.13 0 0 1-5.225-1.617v7.617a5.25 5.25 0 1 1-5.25-5.25c.343 0 .68.031 1.008.092v2.61a2.743 2.743 0 1 0 1.742 2.548V2h2.5Z"
                      fill="currentColor"
                    />
                  </svg>
                </a>
